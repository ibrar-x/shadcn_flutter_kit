...
class FocusOutlineThemeSchema {
  static const String id = 'focus_outline';
  ...
  "id": "focus_outline",
  "title": "Focus Outline Theme",
  "description": "Keyboard focus visualization outline with theming support. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "align",
          "label": "Align",
          "description": "Align in pixels (affected by theme.scaling).",
          "defaultValue": 3.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
