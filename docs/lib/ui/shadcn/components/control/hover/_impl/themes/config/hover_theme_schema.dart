...
class HoverThemeSchema {
  static const String id = 'hover';
  ...
  "id": "hover",
  "title": "Hover Theme",
  "description": "Hover timing helpers plus lightweight state tracking widgets. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "showDuration",
          "label": "Show Duration",
          "description": "Show or hide Show Duration.",
          "defaultValue": null,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
