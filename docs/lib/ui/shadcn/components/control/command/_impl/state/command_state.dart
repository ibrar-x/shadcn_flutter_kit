                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Wrap(
                        spacing: theme.scaling * 12,
                        runSpacing: theme.scaling * 4,
                        children: [
                          _CommandHint(
                            icon: const SingleActivator(
                              LogicalKeyboardKey.arrowUp,
                            ),
                            label: localization.commandMoveUp,
                          ),
                          _CommandHint(
                            icon: const SingleActivator(
                              LogicalKeyboardKey.arrowDown,
                            ),
                            label: localization.commandMoveDown,
                          ),
                          _CommandHint(
                            icon: const SingleActivator(
                              LogicalKeyboardKey.enter,
                            ),
                            label: localization.commandActivate,
                          ),
                        ],
                      ),
                    ),
