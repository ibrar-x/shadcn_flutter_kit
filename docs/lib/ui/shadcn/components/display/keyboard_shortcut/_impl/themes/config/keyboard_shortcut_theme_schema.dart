...
class KeyboardShortcutThemeSchema {
  static const String id = 'keyboard_shortcut';
  ...
  "title": "Keyboard Shortcut Theme",
  "description": "Displays keyboard shortcuts as styled keycaps. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "keyPadding",
          "label": "Key Padding",
          "description": "Key Padding in pixels (affected by theme.scaling).",
          "defaultValue": null,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "keyShadow",
          "label": "Key Shadow",
          "description": "Key Shadow in pixels (affected by theme.scaling).",
          "defaultValue": null,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
