...
class DropdownMenuThemeSchema {
  static const String id = 'dropdown_menu';
  ...
  "id": "dropdown_menu",
  "title": "Dropdown Menu Theme",
  "description": "Dropdown menu overlay built on menu primitives. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "minWidth",
          "label": "Min Width",
          "description": "Min Width in pixels (affected by theme.scaling).",
          "defaultValue": 192.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
