...
class MenubarThemeSchema {
  static const String id = 'menubar';
  ...
  "id": "menubar",
  "title": "Menubar Theme",
  "description": "Horizontal desktop-style menubar with dropdown menus and keyboard navigation. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
