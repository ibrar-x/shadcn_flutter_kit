...
class AlertThemeSchema {
  ...
  "id": "alert",
  "title": "Alert Theme",
  "description": "Flexible alert panels with destructive/resilient styling. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "destructive",
          "label": "Destructive",
          "description": "Toggle Destructive.",
          "defaultValue": false,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
