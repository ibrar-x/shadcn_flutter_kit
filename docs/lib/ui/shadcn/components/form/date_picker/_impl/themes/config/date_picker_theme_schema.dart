...
class DatePickerThemeSchema {
  ...
  "id": "date_picker",
  "title": "Date Picker Theme",
  "description": "Popover/dialog calendar for single-date and range selection. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "description": "Initial View Type in pixels (affected by theme.scaling).",
          "defaultValue": "date",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
