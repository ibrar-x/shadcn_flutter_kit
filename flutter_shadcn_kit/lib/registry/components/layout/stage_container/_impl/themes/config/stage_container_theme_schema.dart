...
class StageContainerThemeSchema {
  static const String id = 'stage_container';
  ...
  "id": "stage_container",
  "title": "Stage Container Theme",
  "description": "Responsive container that snaps to breakpoint widths. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "breakpoint",
          "label": "Breakpoint",
          "description": "Breakpoint in pixels (affected by theme.scaling).",
