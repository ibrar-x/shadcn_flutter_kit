...
class CollapsibleThemeSchema {
  static const String id = 'collapsible';
  ...
  "id": "collapsible",
  "title": "Collapsible Theme",
  "description": "Independent sections that toggle their own visibility Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "description": "Icon Collapsed in pixels (affected by theme.scaling).",
          "defaultValue": "unfold_more",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
          "validation": {
        ...
        },
        {
          ...
          "name": "iconExpanded",
          "label": "Icon Expanded",
          "description": "Icon Expanded in pixels (affected by theme.scaling).",
          "defaultValue": "unfold_less",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
          "validation": {
      ...
      "fields": [
        {
          ...
          "description": "Cross Axis Alignment in pixels (affected by theme.scaling).",
        ...
        },
        {
          ...
          "description": "Main Axis Alignment in pixels (affected by theme.scaling).",
          "defaultValue": "start",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
