...
class TableThemeSchema {
  ...
  "id": "table",
  "title": "Table Theme",
  "description": "Resizable table layout with headers, footers, and frozen cells. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "resizerColor",
          "label": "Resizer Color",
          "description": "Resizer Color in hex format (#RRGGBB or #AARRGGBB).",
          "defaultValue": "#171717",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
      ...
      "fields": [
        {
          ...
          "description": "Resizer Thickness in pixels (affected by theme.scaling).",
          "defaultValue": 4.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
