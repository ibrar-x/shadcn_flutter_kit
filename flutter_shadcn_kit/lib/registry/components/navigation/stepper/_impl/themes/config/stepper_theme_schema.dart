...
class StepperThemeSchema {
  static const String id = 'stepper';
  ...
  "id": "stepper",
  "title": "Stepper Theme",
  "description": "Multi-step progress with interactive step indicators. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "variant",
          "label": "Variant",
          "description": "Variant in pixels (affected by theme.scaling).",
          "defaultValue": "circle",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
