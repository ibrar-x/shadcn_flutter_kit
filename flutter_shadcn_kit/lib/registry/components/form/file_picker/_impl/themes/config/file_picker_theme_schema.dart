...
class FilePickerThemeSchema {
  static const String id = 'file_picker';
  ...
  "id": "file_picker",
  "title": "File Upload Theme",
  "description": "UI-only drag-drop, tile, and mobile file picker surfaces with upload list management. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.1.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "name": "icon",
          "label": "Icon",
          "description": "Icon in pixels (affected by theme.scaling).",
          "defaultValue": null,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
