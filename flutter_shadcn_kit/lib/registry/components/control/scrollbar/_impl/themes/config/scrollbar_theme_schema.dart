...
class ScrollbarThemeSchema {
  static const String id = 'scrollbar';
  ...
  "description": "Themeable scrollbar wrapper built on RawScrollbar. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "radius",
          "label": "Radius",
          "description": "Radius in pixels (affected by theme.radius).",
          "defaultValue": null,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "label": "Hover Animation Duration",
          "description": "Hover Animation Duration in milliseconds.",
          "defaultValue": 200,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
      ...
      "fields": [
        {
          ...
          "name": "interactive",
          "label": "Interactive",
          "description": "Toggle Interactive.",
          "defaultValue": true,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
        ...
        },
        {
          ...
          "name": "minLength",
          "label": "Min Length",
          "description": "Min Length in pixels (affected by theme.scaling).",
          "defaultValue": 48.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
        ...
        },
        {
          ...
          "name": "thickness",
          "label": "Thickness",
          "description": "Thickness in pixels (affected by theme.scaling).",
          "defaultValue": 7.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
        ...
        },
        {
          ...
          "name": "timeToFade",
          "label": "Time To Fade",
          "description": "Time To Fade in milliseconds.",
          "defaultValue": 600,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
