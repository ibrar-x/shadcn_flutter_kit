...
class TrackerThemeSchema {
  static const String id = 'tracker';
  ...
  "id": "tracker",
  "title": "Tracker Theme",
  "description": "Horizontal tracker segments with tooltips. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "name": "itemHeight",
          "label": "Item Height",
          "description": "Item Height in pixels (affected by theme.scaling).",
          "defaultValue": 32.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
