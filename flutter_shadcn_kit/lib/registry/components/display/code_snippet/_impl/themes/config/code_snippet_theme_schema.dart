...
class CodeSnippetThemeSchema {
  static const String id = 'code_snippet';
  ...
  "description": "Stylized code container with action slot and theme overrides. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
