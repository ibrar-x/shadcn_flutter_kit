...
class ChipThemeSchema {
  ...
  "id": "chip",
  "title": "Chip Theme",
  "description": "Compact tag-style button with optional leading/trailing widgets. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "description": "Button Padding in pixels (affected by theme.scaling).",
          "defaultValue": "zero",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
      ...
      "fields": [
        {
          ...
          "name": "style",
          "label": "Style",
          "description": "Style in pixels (affected by theme.scaling).",
