...
class DotIndicatorThemeSchema {
  static const String id = 'dot_indicator';
  ...
  "id": "dot_indicator",
  "title": "Dot Indicator Theme",
  "description": "Animated dot indicator for carousels/steppers with optional tap behavior. Theme tokens and editor schema.",
  "schemaVersion": 1,
  "since": "1.0.0",
  "migrations": {},
  "groups": [
      ...
      "fields": [
        {
          ...
          "description": "Inactive Border Width in pixels (affected by theme.scaling).",
          "defaultValue": 2.0,
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "description": "Inactive Border Color in hex format (#RRGGBB or #AARRGGBB).",
          "defaultValue": "#F5F5F5",
          "required": false,
          "isAdvanced": false,
          "visibleIf": [],
