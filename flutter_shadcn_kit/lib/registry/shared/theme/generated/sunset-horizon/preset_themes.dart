...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadowXs: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadowSm: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadow: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadowMd: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadowLg: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadowXl: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
      shadow2xl: const [BoxShadow(offset: Offset(0, 6), blurRadius: 12, spreadRadius: -3, color: Color(0x17000000))],
    ),
