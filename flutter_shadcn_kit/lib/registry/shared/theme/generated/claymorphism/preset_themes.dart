...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadowXs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadowSm: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadow: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadowMd: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadowLg: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadowXl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
      shadow2xl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 10, spreadRadius: 4, color: Color(0x2E95959D))],
    ),
