...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadowXs: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadowSm: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadow: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadowMd: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadowLg: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadowXl: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
      shadow2xl: const [BoxShadow(offset: Offset(0, 2), blurRadius: 0, spreadRadius: 0, color: Color(0x04333333))],
    ),
