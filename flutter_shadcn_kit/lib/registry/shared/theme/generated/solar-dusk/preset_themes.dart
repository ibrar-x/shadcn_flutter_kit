...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadowXs: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadowSm: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadow: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadowMd: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadowLg: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadowXl: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
      shadow2xl: const [BoxShadow(offset: Offset(0, 2), blurRadius: 3, spreadRadius: 0, color: Color(0x2E4B3F34))],
    ),
  ...
  darkTokens: RegistryThemePresetTokens(
    ...
    tracking: TrackingScale(normal: 0),
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadowXs: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadowSm: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadow: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadowMd: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadowLg: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadowXl: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
      shadow2xl: const [BoxShadow(offset: Offset(0, 0), blurRadius: 0, spreadRadius: 0, color: Color(0xFF0D0D0D))],
    ),
  ),
  ),
];
