...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadowXs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadowSm: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadow: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadowMd: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadowLg: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadowXl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
      shadow2xl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x33835EF3))],
    ),
