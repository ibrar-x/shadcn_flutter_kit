...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadowXs: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadowSm: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadow: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadowMd: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadowLg: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadowXl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
      shadow2xl: const [BoxShadow(offset: Offset(2, 2), blurRadius: 4, spreadRadius: 0, color: Color(0x2604232F))],
    ),
