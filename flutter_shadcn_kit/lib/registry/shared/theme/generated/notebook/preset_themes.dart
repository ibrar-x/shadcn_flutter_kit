...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadowXs: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadowSm: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadow: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadowMd: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadowLg: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadowXl: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
      shadow2xl: const [BoxShadow(offset: Offset(1, 4), blurRadius: 5, spreadRadius: 0, color: Color(0x08000000))],
    ),
