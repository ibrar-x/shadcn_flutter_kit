...
final List<RegistryThemePreset> registryThemePresets = <RegistryThemePreset>[
  ...
  lightTokens: RegistryThemePresetTokens(
    ...
    shadows: ShadowScale(
      shadow2xs: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadowXs: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadowSm: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadow: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadowMd: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadowLg: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadowXl: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
      shadow2xl: const [BoxShadow(offset: Offset(0, 4), blurRadius: 6, spreadRadius: 0, color: Color(0x1F2D2D53))],
    ),
